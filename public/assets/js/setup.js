...
function initialize() {
    ...
    var latlang = new google.maps.LatLng(28.5466, 77.271586);
    var mapOptions = {
    ...
    infowindow.setContent('<address>G. B. Pant Engineering College<br>Govind Puri, Okhla Phase-III <br>New Delhi, Delhi<br>PIN 110020<br>Tel: +91-(011)-2638 2314</address>');
